		...
		<div class="wrapper">
			...
			<div class="box content content0">
				...
				<div class="rte">
					...
					<div style="text-align: left;"></div>
					<div style="text-align: left;"><a href="https://miljoevenlig-pakning.dk/" target="_blank" title="Miljøvenlig Pakning" rel="noopener noreferrer" aria-describedby="a11y-new-window-external-message"><img src="mærkater/miljoe-pakning-badge-150x150-1.avif" alt="" width="" height="" style="float: none; display: block; margin-left: auto; margin-right: auto;"></a></div>
					<br>
					<div style="text-align: center;">
						<a href="https://plastiknejtak.dk/" title="Plastik Nej Tak" aria-describedby="a11y-external-message">
							<img src="mærkater/pntmaerket_160x160.avif" width="160x160" height="160x160" style="float: none;">
						</a>
					</div>
      			</div>
			</div>
